...
public class Algoritimo {
    ...
    public static Populacao novaGeracao(Populacao populacao, boolean elitismo) {
        ...
        //se tiver elitismo, mantém o melhor individuo da geração atual
        if (elitismo) {
            novaPopulacao.setIndividuo(populacao.getIndivduo(0));
        }

        //insere novos individuos na nova população, até atingir o tamanho máximo
    ...
    public static Individuo[] selecaoTorneio(Populacao populacao) {
        ...
        //seleciona 3 individuos aleatoriamente na população
